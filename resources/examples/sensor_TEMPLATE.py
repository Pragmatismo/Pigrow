...
class sensor_config():
    ...
    def find_settings():
        ...
        '''
        print("connection_type=TEMPLATE")
        print("connection_address_list=TEMPLATE")
        print("default_connection_address=TEMPLATE")
        print("available_info=TEMPLATE")
        print("available_settings=TEMPLATE")
...
def read_sensor(location="", extra="", sensor_name="", raw_only=False, *args):
    ...
    try:
        ...
        print("TEMPLATE module not installed, install using the command;")
    ...
    while read_attempt < 5:
        try:
            ...
            if valid_result == "None":
                ...
                data = [['time',logtime], ['TEMPLATE',valid_result]]
                return data
        # Handle problems with sensor module
        except Exception as e:
            print("--exception while reading TEMPLATE, try " + str(read_attempt))
            print(" -- " + str(e))
            time.sleep(2)
            read_attempt = read_attempt + 1
