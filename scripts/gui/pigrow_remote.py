...
import shared_data
import panels.link_pnl as link_pnl
import panels.blank_pnl as blank_pnl

list_of_panels = ['start_pnl', 'system_pnl', 'cron_pnl', 'camera_pnl', 'timelapse_pnl', 'localfiles_pnl', 'sensors_pnl', 'power_pnl', 'watering_pnl', 'graphs_pnl', 'datawall_pnl', 'display_pnl', 'userlog_pnl']
for x in list_of_panels:
    import_cmd = "from panels import " + x + " as " + x
    exec(import_cmd)
