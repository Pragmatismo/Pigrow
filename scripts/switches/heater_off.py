...
for argu in sys.argv[1:]:
    if argu == '-h' or argu == '--help':
        ...
        print("")
        print("This turns the Heater OFF")
...
def heater_off(set_dic, switch_log):
    ...
    msg +=("      #############################################\n")
    pigrow_defs.set_condition(condition_name="heater", trig_direction="off", cooldown="none")
...
if __name__ == '__main__':
    ...
    msg = heater_off(set_dic, loc_dic['loc_switchlog'])
    print (msg)
