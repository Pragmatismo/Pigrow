...
try:
    ...
    with open(locswitchlog, "a") as f:
        line = 'lamp_off.py G' + str(datetime.datetime.now()) + 'G failed - settings file error\n'
        f.write(line)
...
if 'gpio_lamp' in pi_set and not pi_set['gpio_lamp'] == '':
    ...
    if gpio_pin_on == "low":
        ...
        print("      !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
        with open(locswitchlog, "a") as f:
            line = 'lamp_off.py G' + str(datetime.datetime.now()) + 'G failed - no direction set in config\n'
            f.write(line)
        print("Log writen:" + line)
        exit()
    ...
    print("      !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
    with open(locswitchlog, "a") as f:
        line = 'lamp_off.py G' + str(datetime.datetime.now()) + 'G failed - none set in config\n'
        f.write(line)
    print("Log writen:" + line)
    exit()
...
print("      #############################################")
with open(locswitchlog, "a") as f:
        line = 'lamp_off.py G' + str(datetime.datetime.now()) + 'Lamp turned off\n'
        f.write(line)
print("Log writen:" + line)
