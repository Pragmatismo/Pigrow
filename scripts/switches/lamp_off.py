...
try:
    ...
    with open(locswitchlog, "a") as f:
        line = 'Lamp failed to turn ON at ' + str(datetime.datetime.now()) + ' - ettings file error\n'
        f.write(line)
...
if 'gpio_lamp' in pi_set and not pi_set['gpio_lamp'] == '':
    ...
    if gpio_pin_on == "low":
        ...
        print("      !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
        with open(locswitchlog, "a") as f:
            line = 'Lamp failed to turn OFF at ' + str(datetime.datetime.now()) + ' - no direction set in config\n'
            f.write(line)
        print("Log writen:" + line)
        exit()
    ...
    print("      !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
    with open(locswitchlog, "a") as f:
        line = 'Lamp failed to turn OFF at ' + str(datetime.datetime.now()) + ' due to none set in config\n'
        f.write(line)
    print("Log writen:" + line)
    exit()
...
print("      #############################################")
with open(locswitchlog, "a") as f:
        line = 'Lamp turned OFF at ' + str(datetime.datetime.now()) + '\n'
        f.write(line)
print("Log writen:" + line)
