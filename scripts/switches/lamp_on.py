...
try:
    ...
    with open(locswitchlog, "a") as f:
        line = 'Lamp_on.py @' + str(datetime.datetime.now()) + '@ settings file error\n'
        f.write(line)
...
if 'gpio_lamp' in pi_set and not pi_set['gpio_lamp'] == '':
    ...
    if gpio_pin_on == "low":
        ...
        print("      !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
        with open(locswitchlog, "a") as f:
            line = 'Lamp_on.py @' + str(datetime.datetime.now()) + '@ - no direction set in config\n'
            f.write(line)
        print("Log writen:" + line)
        exit()
    ...
    print("      !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
    with open(locswitchlog, "a") as f:
        line = 'Lamp_on.py @' + str(datetime.datetime.now()) +'@ to none set in config\n'
        f.write(line)
    print("Log writen:" + line)
    exit()
...
print("      #############################################")
with open(locswitchlog, "a") as f:
        line = 'Lamp_on.py @' + str(datetime.datetime.now()) + '@Lamp turned on\n'
        f.write(line)
print("Log writen:" + line)
