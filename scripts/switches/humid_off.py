...
print("")
print("      #############################################")
print("      ##         Turning the humidifier - OFF    ##")
...
try:
    ...
    with open(locswitchlog, "a") as f:
        line = 'humid_off.py @' + str(datetime.datetime.now()) + '@ Failed - settings file error\n'
        f.write(line)
...
if 'gpio_humid' in pi_set and not pi_set['gpio_humid'] == '':
    ...
    if gpio_pin_on == "low":
        ...
        print("skipping setting gpio HIGH as TESTING TEST TEST TEST")
    else:
        print("      !!       CAN'T DETERMINE GPIO DIRECTION   !!")
        print("      !!  run config program or edit config.txt !!")
        print("      !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
        with open(locswitchlog, "a") as f:
            line = 'humid_off.py @' + str(datetime.datetime.now()) + '@ Failed - - no direction set in config\n'
            f.write(line)
        print("Log writen:" + line)
        exit()
    ...
    print("      !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
    with open(locswitchlog, "a") as f:
        line = 'humid_off.py @' + str(datetime.datetime.now()) + '@ Failed - none set in config\n'
        f.write(line)
    print("Log writen:" + line)
    exit()
...
print("      #############################################")
with open(locswitchlog, "a") as f:
        line = 'humid_off.py @' + str(datetime.datetime.now()) + '@ Humidifier Turned off  \n'
        f.write(line)
print("Log writen:" + line)
