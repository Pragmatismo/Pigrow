...
try:
    ...
    with open(locswitchlog, "a") as f:
        line = 'heater_on.py @' + str(datetime.datetime.now()) + '@ Failed - settings file error\n'
        f.write(line)
...
if 'gpio_heater' in pi_set and not pi_set['gpio_heater'] == '':
    ...
    if gpio_pin_on == "low":
        ...
        print("      !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
        with open(locswitchlog, "a") as f:
            line = 'heater_on.py @' + str(datetime.datetime.now()) + '@ Failed - no direction set in config\n'
            f.write(line)
        print("Log writen:" + line)
        exit()
    ...
    print("      !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
    with open(locswitchlog, "a") as f:
        line = 'heater_on.py @' + str(datetime.datetime.now()) + '@ Failed - due to none set in config\n'
        f.write(line)
    print("Log writen:" + line)
    exit()
...
print("      #############################################")
with open(locswitchlog, "a") as f:
        line = 'heater_on.py @' + str(datetime.datetime.now()) + '@ Heater turned on  \n'
        f.write(line)
print("Log writen:" + line)
