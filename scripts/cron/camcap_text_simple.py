...
if not dht22_sensor_pin == None or nulsensorshow==True:
    if not temp == "99999":
        ...
        d.text((xpos,ypos-1+(font_size*2)), "Temp: no data", font=fnt, fill=(0,0,0,t_alpha))
        d.text((xpos,ypos-1+(font_size*3)), "Humid: no data", font=fnt, fill=(0,0,0,t_alpha))
        d.text((xpos+1,ypos+(font_size*2)), "Temp: no data", font=fnt, fill=(0,0,0,t_alpha))
        d.text((xpos+1,ypos+(font_size*3)), "Humid: no data", font=fnt, fill=(0,0,0,t_alpha))
        d.text((xpos-1,ypos+(font_size*2)), "Temp: no data", font=fnt, fill=(0,0,0,t_alpha))
        d.text((xpos-1,ypos+(font_size*3)), "Humid: no data", font=fnt, fill=(0,0,0,t_alpha))
        ...
        d.text((xpos,ypos-1+(font_size*2)), "Temp: ", font=fnt, fill=(0,0,0,t_alpha))
        d.text((xpos,ypos-1+(font_size*3)), "Humid: ", font=fnt, fill=(0,0,0,t_alpha))
        d.text((xpos+1,ypos+(font_size*2)), "Temp: ", font=fnt, fill=(0,0,0,t_alpha))
        d.text((xpos+1,ypos+(font_size*3)), "Humid: ", font=fnt, fill=(0,0,0,t_alpha))
        d.text((xpos-1,ypos+(font_size*2)), "Temp: ", font=fnt, fill=(0,0,0,t_alpha))
        d.text((xpos-1,ypos+(font_size*3)), "Humid: ", font=fnt, fill=(0,0,0,t_alpha))
